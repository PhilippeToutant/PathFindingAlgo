...
using UnityEngine;
/// <summary>
/// Class de l'algorythme du pathfinding 
/// </summary>
public class Pathfinding {

    private const int MOVE_STRAIGHT_COST = 10;
    private const int MOVE_DIAGONAL_COST = 40;

    public static Pathfinding Instance { get; private set; }

    private Tableau<PathNode> grid;
    ...
    public Pathfinding(int width, int height) {
        Instance = this;
        grid = new Tableau<PathNode>(width, height, 10f, Vector3.zero, (Tableau<PathNode> g, int x, int y) => new PathNode(g, x, y));
    }
    /// <summary>
    /// 
    /// </summary>
    /// <returns></returns>
    public Tableau<PathNode> GetGrid() {
        return grid;
    }
    /// <summary>
    /// 
